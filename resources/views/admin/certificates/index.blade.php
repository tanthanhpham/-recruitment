@extends('admin.certificates.layout', [
    'title' => ( $title ?? 'Create Certificate' )
])
                        ...
                        <div class="card-inner p-0">
                            <div class="alert m-0">
                                <div class="alert alert-warning alert-icon">
                                    <em class="icon ni ni-alert-circle"></em> Bạn chưa thêm băng cấp nào</a>.
                                ...
                                @foreach($certificates as $i => $certificate)
                                    <div class="nk-tb-item">
                                        ...
                                        <span class="tb-product">
                                            <span class="title">{{ $certificate->bangcap_ten }}</span>
                                        </span>
                                        </div>
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1 my-n1">
                                                            ...
                                                            <ul class="link-list-opt no-bdr">
                                                                <li>
                                                                    <a href="{{ route('certificate.edit',['id' => $certificate->id]) }}">
                                                                        <em class="icon ni ni-edit"></em><span>Edit certificate</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('certificate.delete',['id' => $certificate->id]) }}">
                                                                        <em class="icon ni ni-trash"></em><span>Delete certificate</span>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </div>
