                        ...
                        <div class="card-inner p-0">
                            <div class="alert m-0">
                                <div class="alert alert-warning alert-icon">
                                    <em class="icon ni ni-alert-circle"></em> Bạn chưa thêm vị trí nào</a>.
                                </div>
                            </div>
                        </div>
                    @else
                                                            ...
                                                            <ul class="link-list-opt no-bdr">
                                                                <li>
                                                                    <a href="{{ route('position.edit',['id' => $position->id]) }}">
                                                                        <em class="icon ni ni-edit"></em><span>Edit position</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('position.delete',['id' => $position->id]) }}">
                                                                        <em class="icon ni ni-trash"></em><span>Delete position</span>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </div>
